...
export default function Header() {
  ...
  return (
    <header className="w-full py-3 border-b border-gray-4 bg-background/85 backdrop-blur">
      <Flex justify="between" gap="4" align="center" px="4">
        ...
        <Flex align="center" gap="3" className="shrink-0" justify="end">
