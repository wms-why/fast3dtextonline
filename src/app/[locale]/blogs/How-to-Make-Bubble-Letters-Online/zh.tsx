...
export default function Page() {
  return (
    <Flex gap={"4"} direction={"column"} justify={"start"} className="text-left">
      ...
      <Flex justify={"center"}>
        <Image src={img} alt="泡泡字模板预览" width={1024} height={576} />
      </Flex>
      ...
      <Card size="3">
        <Flex direction={"column"} gap={"3"}>
          ...
          <Text as="p">
            1. 打开 <Link href="/zh/styles/bubble-letters">泡泡字 3D 文字生成器</Link>。
          </Text>
      ...
      <Text as="p">
        ...
        <Link href="/zh/styles/bubble-letters"> 泡泡字模板页 </Link>
        再继续修改。
      </Text>
    </Flex>
  );
