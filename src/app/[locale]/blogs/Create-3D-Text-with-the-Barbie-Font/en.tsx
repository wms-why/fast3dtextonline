...
export default function Page() {
  return (
    <Flex gap={"4"} direction={"column"} justify={"start"} className='text-left'>
      ...
      <Text as="p" mb="2">
        Fast3DText now supports direct uploads for `.ttf`, `.otf`, and `.json` font files, so you can skip the old conversion step entirely.
      </Text>
      <Heading as="h3" size="4" mt="4" mb="2">Instructions:</Heading>
      <ul style={{ listStyleType: 'decimal', paddingLeft: '20px' }}>
        <li>Open the editor on Fast3DText.com.</li>
        <li>Click "Upload Font".</li>
        <li>Select the `barbie.ttf` file you downloaded in Step 1.</li>
      </ul>
